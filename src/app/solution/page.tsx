      ...
      <div className="my-15 md:mx-20">
        <div>
          ...
          <div className="md:justify-arround md:mt-10 md:flex md:items-center">
            ...
            <p className="mx-auto mt-8 w-70 md:mt-0 md:w-150">
              Faites de la finance votre meilleure alliée. Avec Foncior, pilotez
              le budget de vos investissements sans effort. Suivez le capital
              restant dû de vos emprunts pour chaque location directement depuis
              votre espace. Véritable solution d&apos;aide à la décision,
              Foncior vous permet de générer instantanément des reportings et
              attestations de revenus fiables pour vos partenaires bancaires.
            </p>
          </div>
        </div>
        <div className="md:mt-15">
          ...
          <div className="md:justify-arround md:mt-10 md:flex md:flex-row-reverse md:items-center">
            ...
            />
            <p className="mx-auto mt-8 w-70 md:mt-0 md:w-150">
              Gestion des réservations et suivi locataire simplifiés. Avec la
              solution Foncior, gardez un œil sur chaque location passée ou à
              venir grâce à notre calendrier interactif. Visualisez
              instantanément l&apos;impact de vos réservations sur votre budget
              et votre finance globale. Retrouvez en un clic l&apos;historique
              complet de vos états des lieux, vos revenus générés et les
              dossiers de vos anciens locataires.
            </p>
          </div>
        </div>
        <div className="md:mt-15">
          ...
          <div className="md:justify-arround md:mt-10 md:flex md:items-center">
            ...
            <p className="mx-auto mt-8 w-70 md:mt-0 md:w-150">
              ...
              décisions stratégiques et faire croître votre patrimoine.
            </p>
          </div>
        </div>
      </div>
